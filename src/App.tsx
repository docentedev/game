...
Game.init(() => {
  ...
  const game = new Game({
      targetID: 'game',
      w: 64*9, // cuantas unit en x
      h: 600, // cuantas unit en y
      blockSize: 64,
  })
  ...
  game.images.onAllLoad(() => {
      ...
      game.addBlock(new Block({ sprite: game.sprites['sprite'], spriteTitle: 'ladrilloBlockRotoConPiedraHoja', x: game.bz(4), y: game.bz(4), w: game.bz(1), h: game.bz(1) }))
